...
public class TischDarkOak extends Block {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static TischDarkOak TischDarkOak = new TischDarkOak();

	protected TischDarkOak() {
		super(Material.wood);
		this.setUnlocalizedName("TischDarkOak");
		this.setStepSound(Block.soundTypeMetal);
		this.setCreativeTab(MoTab.MoFurniture);
	}
